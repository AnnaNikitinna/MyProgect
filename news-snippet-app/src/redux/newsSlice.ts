...
interface NewsState {
  showModal: boolean; // исправлено на boolean
...
export const newsSlice = createSlice({
  ...
  initialState,
  reducers: {
    setNewsList(state, action: PayloadAction<IData_SnippetNews[]>) {
...
export const { setNewsList, closeModal, setShowModal } = newsSlice.actions;
